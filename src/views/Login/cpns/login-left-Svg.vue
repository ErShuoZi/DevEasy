<template>
  <div class="box-left first-box">
    ...
    >
      ...
      <image
        id="loc1"
        xlink:href="../../../assets/images/redPoint.png"
      ...
      <image
        id="loc2"
        xlink:href="../../../assets/images/smPoint.png"
        preserveAspectRatio="none"
        x="155"
        y="69.97776888888889"
        width="25"
      ...
      ></image>
      <image
        xlink:href="../../../assets/images/bg-red.png"
        preserveAspectRatio="none"
        x="278"
        y="94"
        width="30"
      ...
      ></image>
      <image
        xlink:href="../../../assets/images/first-smbg.png"
        preserveAspectRatio="none"
        x="438"
        y="125"
        width="20"
...
.first-box {
  ...
  width: 600px;
  height: 314px;
  background: url(../../../assets/images/bg-location.png);
...
#loc3 {
  animation: moveLoc1Icon3 1s linear infinite alternate;
